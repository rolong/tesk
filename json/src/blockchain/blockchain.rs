...
impl BlockChain {
	...
	pub fn genesis(&self) -> Genesis {
		Genesis {
			...
			signature: Some(self.genesis_block.signature.clone()),
			base_target: Some(self.genesis_block.base_target.clone()),
			hash_rate: Some(self.genesis_block.hash_rate.clone()),
		}
	}
}
		...
		let s = r#"{
			"blocks" : [{
				"blockHeader" : {
					...
					"signature" : ""
				},
