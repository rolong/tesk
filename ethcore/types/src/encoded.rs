...
impl Header {
    ...
    /// Generator signature of this block.
    ...
    /// Base-target of this block.
    pub fn base_target(&self) -> u64 {
        self.view().base_target()
    }

    /// Hash-rate of this block.
...
impl Block {
    ...
    /// Base_target of this block.
    pub fn base_target(&self) -> u64 {
        self.header_view().base_target()
    }

    /// Hash_rate of this block.
    pub fn hash_rate(&self) -> U256 {
        self.header_view().hash_rate()
    }
}
