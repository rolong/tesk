...
pub enum BlockError {
    ...
    /// Proof-of-Capacity aspect of seal, which we assume is a 256-bit value, is invalid.
    InvalidProofOfCapacity(OutOfBounds<U256>),
    /// Proof-of-Capacity deadline is invalid.
    InvalidDeadline(u64),
...
impl fmt::Display for BlockError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        let msg = match *self {
            ...
            InvalidProofOfCapacity(ref oob) => format!("Block has invalid PoC: {}", oob),
            InvalidDeadline(ref num) => format!("Block has invalid PoC Deadline: {}", num),
...
error_chain! {
	...
	errors {
		...
		#[doc = "The value of deadline is invalid."]
		PoCBlockSignatureInvalid {
			description("The value of Blcok signature is invalid.")
			display("The value of Blcok signature is invalid.")
		}

		#[doc = "The value of deadline is invalid."]
		PoCDeadineInvalid(expected: u64, value: u64) {
			description("The value of deadline is invalid.")
			display("The value of deadline is invalid, Expected: ({}), Get: ({}).", expected, value)
		}

		#[doc = "The value of the PoC no signer ."]
		PoCEngineNoSigner {
			description("The value of the PoC no signer.")
			display("The value of the PoC no signer.")
		}
