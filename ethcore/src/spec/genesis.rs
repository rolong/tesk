...
impl From<ethjson::spec::Genesis> for Genesis {
    fn from(g: ethjson::spec::Genesis) -> Self {
        Genesis {
            ...
            base_target: g.base_target.map_or(0, Into::into),
            hash_rate: g.hash_rate.map_or_else(U256::zero, Into::into),
            signature: g.signature.map_or_else(H256::zero, Into::into),
        }
    }
}
