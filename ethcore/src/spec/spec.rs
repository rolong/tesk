...
use engines::{
    ...
    Skhash, DEFAULT_BLOCKHASH_CONTRACT,
};
use error::Error;
...
pub struct Spec {
    ...
    /// The genesis block's generate signature field.
    pub signature: H256,

    /// the genesis block's base_target field.
    pub base_target: u64,

    /// the genesis block's hash_rate field.
    pub hash_rate: U256,
...
impl Clone for Spec {
    fn clone(&self) -> Spec {
        Spec {
            ...
            hash_rate: self.hash_rate.clone(),
...
impl Spec {
    ...
    fn engine(
        ...
        match engine_spec {
            ...
            ethjson::spec::Engine::Skhash(skhash) => {
                Skhash::new(spec_params.cache_dir, skhash.params.into(), machine)
            }
        }
    }
    ...
    pub fn genesis_header(&self) -> Header {
        ...
        header.set_signature(self.signature.clone());
        header.set_base_target(self.base_target);
        header.set_hash_rate(self.hash_rate);
    ...
    pub fn overwrite_genesis_params(&mut self, g: Genesis) {
        ...
        self.base_target = g.base_target;
        self.hash_rate = g.hash_rate;
        self.signature = g.signature;
    }
