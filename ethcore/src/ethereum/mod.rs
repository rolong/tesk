...
/// Create a new Skhash PoC mainnet chain spec.
pub fn new_skhash<'a,T: Into<SpecParams<'a>>>(params: T) -> Spec {
	load(params.into(),include_bytes!("../../res/ethereum/skhash.json"))
}
...
///Create new Skhash PoC spec.
pub fn new_skhash_test_machine() -> EthereumMachine {load_machine(include_bytes!("../../res/ethereum/skhash_test.json"))}
