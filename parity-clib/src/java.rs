...
#[no_mangle]
pub unsafe extern "system" fn Java_io_seek_chain_Parity_configFromCli(env: JNIEnv, _: JClass, cli: jobjectArray) -> jlong {
...
#[no_mangle]
pub unsafe extern "system" fn Java_io_parity_seek_chain_build(
	env: JNIEnv,
	_: JClass,
	config: va_list,
	logger_mode: JString,
...
#[no_mangle]
pub unsafe extern "system" fn Java_io_parity_seek_chain_destroy(_env: JNIEnv, _: JClass, parity: va_list) {
...
#[no_mangle]
pub unsafe extern "system" fn Java_io_parity_seek_chain_rpcQueryNative(
	env: JNIEnv,
	_: JClass,
	parity: va_list,
	rpc: JString,
...
#[no_mangle]
pub unsafe extern "system" fn Java_io_parity_seek_chain_subscribeWebSocketNative(
	env: JNIEnv,
	_: JClass,
	parity: va_list,
	rpc: JString,
...
#[no_mangle]
pub unsafe extern "system" fn Java_io_parity_seek_chain_unsubscribeWebSocketNative(
	_: JNIEnv,
	_: JClass,
	session: va_list) {
