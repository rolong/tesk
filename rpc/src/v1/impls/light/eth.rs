...
use v1::helpers::{errors, limit_logs, PollManager, SyncPollFilter};
use v1::impls::eth_filter::Filterable;
use v1::metadata::Metadata;
use v1::traits::{Eth, EthMining};
use v1::types::{
    Block, BlockNumber, BlockTransactions, Bytes, CallRequest, EthAccount, Filter, Index,
    LightBlockNumber, Log, MiningInfo, Nonce, Receipt, RichBlock, SubmitNonceResponse,
    SyncInfo as RpcSyncInfo, SyncStatus as RpcSyncStatus, Transaction, Work,
};
        ...
        let fill_rich = move |block: encoded::Block, score: Option<U256>| {
            ...
            RichBlock {
                inner: Block {
                    ...
                    base_target: header.base_target().into(),
                    hash_rate: header.hash_rate().into(),
...
impl<C, S, OD> EthMining for EthClient<C, S, OD>
where
