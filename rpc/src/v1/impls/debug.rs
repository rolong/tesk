...
use v1::traits::Debug;
use v1::types::{Block, BlockTransactions, Bytes, RichBlock, Transaction};
            ...
            .map(|(block, reason)| {
                ...
                RichBlock {
                    inner: Block {
                        ...
                        signature: cast(block.header.signature()),
                        base_target: block.header.base_target().into(),
                        hash_rate: block.header.hash_rate().into(),
